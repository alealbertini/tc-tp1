...
set title "Información de los paquetes who-has recibidos por IP"
set y2label "Información [bits]"


plot inputFile every 1::1 using 0:3:($3<=entropy? 0x000000 : 0x808080):xticlabels(1) with boxes lc rgb variable, \
